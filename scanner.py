...
if selected_strategy != "Institutional Brokerage News Radar":
  timeframe = st.sidebar.selectbox(
      ...
      index=1,
      help=(
          "Note: Darvas Box and Weekly Momentum permanently override this to 1"
          " Week."
      ),
  )
...
if selected_strategy == "Institutional Brokerage News Radar":
  ...
  st.sidebar.info(
      "Scans Google News RSS for real-time institutional rating calls on your"
      " watchlist."
  )
  ...
  try:
    ...
    if res.status_code == 200:
      ...
      for item in items[:3]:
        ...
        pub_date = pub_date_tag.text if pub_date_tag else "N/A"
